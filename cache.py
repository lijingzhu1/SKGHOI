...
sys.path.append('/users/PCS0256/lijing/spatially-conditioned-graphs/models')
from v_coco_r50_transH_spatial_models import SpatiallyConditionedGraph as SCG
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-root', default='vcoco', type=str)
    parser.add_argument('--detection-dir', default='vcoco/detections/test2014_r50_pretained',
                        type=str, help="Directory where detection files are stored")
    parser.add_argument('--cache-dir', default='vcoco_cache', type=str)
