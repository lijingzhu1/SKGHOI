...
from models.adamixer_transH_models import SpatiallyConditionedGraph as transH_SCG
...
def main(rank, args):
    ...
    optim_2 = torch.optim.SGD(
        param_group_3, lr=args.graph_embedding_learning_rate,
        weight_decay=args.graph_embedding_weight_decay
    )
    ...
    lr_scheduler = torch.optim.lr_scheduler.LambdaLR(
        optim_1, lr_lambda=[lambda1, lambda2]
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-detection-dir', default='hicodet/detections/train2015_r50', type=str)
    parser.add_argument('--val-detection-dir', default='hicodet/detections/test2015_r50', type=str)
