...
from linearH_model import SpatiallyConditionedGraph as transH_SCG
...
def main(rank, args):
    ...
    if args.dataset == 'hicodet':
        ...
        num_objects = 80
    net = transH_SCG(
        object_to_target, human_idx, num_objects,
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--translational-head', default='ConvH', type=str)
