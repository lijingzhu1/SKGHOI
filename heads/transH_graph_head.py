...
class ConvhHead(Module):
    ...
    def forward(self,
        ...
        convh= ConvH(ent_tot = 10, rel_tot = 10,dim = self.transh_dim, p_norm = self.transh_p_norm,\
        ...
        head_entity,relation,relation_norm,tail_entity,transh_scores = convh(all_head,all_relation,all_tail)
