...
from vcoco_r50_transH_spatial_head import InteractionHead, GraphHead
...
class SpatiallyConditionedGraph(GenericHOINetwork):
    def __init__(self,
        ...
        config = '/users/PCS0256/lijing/mmdetection_ascend/checkpoints/vcoco_adamixer/finetuning_r50_36epoch_vcoco/r50_36_epoch_finetuing_vcoco.py'
        checkpoint = '/users/PCS0256/lijing/mmdetection_ascend/checkpoints/vcoco_adamixer/finetuning_r50_36epoch_vcoco/epoch_14.pth'
