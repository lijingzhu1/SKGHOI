...
CUDA_LAUNCH_BLOCKING=1  python configures/transh_main.py --world-size 4 --learning-rate 0.000001 --cache-dir checkpoints/hicodet/transh \
--num-workers 4 --num-epochs 100