...
CUDA_LAUNCH_BLOCKING=1  python configures/hicodet/adamixer_transH_spatial_main.py --world-size 4 --learning-rate  0.0001 --cache-dir checkpoints/hicodet/new_spatial/transh_50 \
