...
CUDA_LAUNCH_BLOCKING=1  python configures/adamixer_transH_main.py --world-size 4 --learning-rate 0.0001 --cache-dir checkpoints/hicodet/transh_3 \
--num-workers 4 --num-epochs 8