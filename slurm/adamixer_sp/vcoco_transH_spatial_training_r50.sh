...
CUDA_LAUNCH_BLOCKING=1  python configures/vcoco/adamixer_transH_spatial_main.py --world-size 4 --learning-rate  0.00005 \
--cache-dir checkpoints/vcoco/transh_50 --num-workers 4 --num-epochs 12 --dataset vcoco \
