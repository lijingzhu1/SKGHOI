...
from adamixer_transH_spatial_models import SpatiallyConditionedGraph as SCG
...
if __name__ == "__main__":
    ...
    parser.add_argument('--detection-dir', default='hicodet/detections/test2015_r101_pretained',
