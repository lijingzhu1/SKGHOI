...
class CustomisedDLE(DistributedLearningEngine):
    ...
    def _on_start(self):
        ...
        # self.transH_loss = pocket.utils.SyncedNumericalMeter(maxlen=self._print_interval)
    ...
    def _on_each_iteration(self):
        ...
        # self.transH_loss.append(loss_dict['transH_loss'])
...
class transH_CustomisedDLE(DistributedLearningEngine):
    def __init__(self, net, train_loader, val_loader, num_classes=117, **kwargs):
        super().__init__(net, None, train_loader, **kwargs)
        self.val_loader = val_loader
        self.num_classes = num_classes
    ...
    def _print_statistics(self):
        ...
        transH_loss = self.transH_loss.mean()
        if self._rank == 0:
            print(f"transH loss: {transH_loss:.4f}")
        self.transH_loss.reset()

class OriginalCustomisedDLE(DistributedLearningEngine):
    def __init__(self, net, train_loader, val_loader, num_classes=117, **kwargs):
        super().__init__(net, None, train_loader, **kwargs)
        self.val_loader = val_loader
        self.num_classes = num_classes
